...
import com.automation.tests.utils.ConfigurationReader;
    ...
    public static WebDriver get() {
        ...
        if (driverPool.get() == null) {
            ...
            switch (browser) {
                ...
                case "mobile_chrome":
                    try {
                        String node = ConfigurationReader.getProperty("mobileChromeNode");//http://localhost:4723
                        ...
                        driverPool.set(new RemoteWebDriver(new URL(node+"/wd/hub"), desiredCapabilities));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    break;
